...
My ambitious goal is to write a machine learning algorithm that predicts authors. But let's start with something simpler but is crucial. An important step in Data Science process is to prepare your data, clean it, reformat it and make it usable for the further analysis.
