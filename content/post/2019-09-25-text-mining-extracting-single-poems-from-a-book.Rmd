...
My ambitious goal is to write a machine learning algorithm that predicts authors. But let's start with something simpler.

[Project Gutenberg](https://www.gutenberg.org/) has a library of over 60,000 free eBooks. I will work on a Poetry book called "New Poems" from D. H. Lawrence. 

**The goal is to isolate each poem individually for text mining analysis later.**  
...
At gutenberg website there are couple of slightly different formats of the book. Since there were some mistakes in the .txt version I used 
the html version [here](http://www.gutenberg.org/files/22726/22726-h/22726-h.htm). I copied the text and pasted it in a txt file and saved to my working directory. 
```{r data}
...
Since the title EMBANKMENT AT NIGHT appears in the titles of two poems we will do a slight correction here. To correct this, I will remove first apperance of index 768 and second appearence of 621.
