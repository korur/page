...
You can find all the information on [github](https://github.com/rfordatascience/tidytuesday). 
...
The data contains information of 83 parameters of more than 40.000 Vehicles. That's a lot of information!
...
We found our answer and our camping gear is ready. Let's tackle some other questions. We here a lot about them but how does the future looks like for Electric cars?

# How does Electric cars evolving in the last years compared to non electric cars?
...
This was a huge dataset that you can answer many more questions. Such as mileage of different car models? Carbon dioxide emissions? etc. 

I have selected some car models which might be worth to look at if luggage space is a priority for you!, and looked at how electric car models evolving in the last years.
