...
description: "This page is about using predictive modeling algorithms"
author: ''
date: '2019-10-01'
output:
    html_document:
...
waffle(zeros, rows=20) + theme(text = element_text(size=15)) + ggtitle("Number of rows with zero")
```
...
One of the big diferences between rf and lmodels Unlike linear models, Random forest requires "tuning."
