...
I look for atomic data types my variables have. I see that the outcome variable is represented as an integer. I will keep this in mind because many machine learning models will accept the binary outcome as factor data type.
...
As a bonus, I can recommend using dplyr package.

**Approach 2:** Much simpler with dplyr **summarise_all()** function

```{r, message=FALSE, warning=FALSE}

diabetes %>%  summarise_all(funs(sum(.==0)))

```


Feed those numbers from the for loop into a waffle plot.
