...
Advances in **microfluidic technologies** enabled us barcoding single cells in lipid droplets and to **resolve genomes of individual cells** from a sequencing mixture (e.g, [10X Genomics](https://www.10xgenomics.com/)). **Single cell RNA sequencing (scRNAseq)** offers opportunities to discover **rare cell populations**  and genes that are specifically expressed in those. Interest is high and the list of publications growing daily.  

* You might be a scientist in a biotech exploring novel targets and those might be a great source to **retrieve specific information.**

[Seurat](https://cran.r-project.org/web/packages/Seurat/index.html) package is a great tool for digging into single cell datasets. Learning it will open you access beyond what is shown in the publications. You can find many tutorials in their [website](https://satijalab.org/seurat/).
...
* **Current therapies does not increase the survival** but novel therapies are underway. 

Here, I picked up data from a patient with Polymyositis associated intersitial lung disease. 
...
# Nintedanib is one of the two new medicines approved for IPF patients.
# It targets multiple receptor tyrosine kinase receptors such as VEGF, 
# FGF and PDGF. 
