...
{{% alert note %}}
Aesthetics does not refer how something looks, **but to which variable is mapped onto it.**
{{% /alert %}}
...
Same goes here. I am changing how something looks like. The data point shape change to 24 which defines a filled triangle. But nothing is mapped onto it. It is just an attribute. 
...
I will tell the rest of the story in the next update. Now play with the app to create your own patterns!
